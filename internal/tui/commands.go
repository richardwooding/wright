...
var keyHelp = []overlay.Entry{
	...
	{Name: "↑ / ↓", Desc: "scroll the transcript (moves the cursor inside a multi-line message)"},
	{Name: "pgup / pgdn · shift+↑ / shift+↓", Desc: "scroll the transcript a page · a line"},
	{Name: "home / end", Desc: "jump to the top · back to following the newest output"},
	{Name: "ctrl+p / ctrl+n", Desc: "previous / next message you sent"},
